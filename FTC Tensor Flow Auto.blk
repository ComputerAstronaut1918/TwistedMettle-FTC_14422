...
<field name="WEBCAM_NAME">Webcam</field>
</shadow>
</value>
...
<next>
<block type="controls_whileUntil" id="QUUF7wOn@kVmWjxTom~8">
<field name="MODE">WHILE</field>
<value name="BOOL">
<block type="logic_compare" id="QC@MeKfKz%x$zR-[Dy}O">
<field name="OP">GT</field>
<value name="A">
<block type="lists_length" id="K`8Y^?HLMQ=toRm4;VU#">
<value name="VALUE">
<block type="variables_get" id="ZUq%-erGR*ut]t.aPzM.">
<field name="VAR" id="C-j=_t;@/fsV)+=e~^La">recognitions</field>
</block>
</value>
</block>
...
<value name="B">
<block type="math_number" id="FJX2Xq;4P2;#p|$98[/H">
<field name="NUM">0</field>
</block>
</value>
</block>
...
<statement name="DO">
<block type="dcMotor_setDualProperty_Number" id="T2npvGVR+{aU/)_xHU4Z">
<field name="PROP">Power</field>
<field name="IDENTIFIER1">motor1AsDcMotor</field>
<field name="IDENTIFIER2">motor0AsDcMotor</field>
<data>{"IDENTIFIER1":"motor 1","IDENTIFIER2":"motor 0"}</data>
<value name="VALUE1">
<shadow type="math_number" id="LFPt/.R+ZM?CIf=8s``v">
<field name="NUM">1</field>
</shadow>
</value>
<value name="VALUE2">
<shadow type="math_number" id="eA]Q}5`)u_ER(oIB[ANP">
<field name="NUM">1</field>
</shadow>
</value>
<next>
<block type="dcMotor_setDualProperty_Number" id="G*v+CL!=:n$i%Ugd(_AP">
<field name="PROP">Power</field>
...
<value name="VALUE1">
<shadow type="math_number" id="*O$)4%OVmT:CW2v@I?vw">
<field name="NUM">1</field>
</shadow>
</value>
<value name="VALUE2">
<shadow type="math_number" id="C~?j)GqRd{]z$X)x|=}}">
<field name="NUM">1</field>
</shadow>
</value>
</block>
...
<block type="procedures_defnoreturn" id=")21zCFQOO-Q6a!/Wu4LO" x="13" y="1753">
<mutation>
